...
These rules track Amarula **0.5.7**. They are a curated subset, not the full API — do
...
`connect/2` instead:
    ...
    children = [Amarula.Supervisor, MyRouter, {Amarula, profile: :sales, parent: MyRouter}]
